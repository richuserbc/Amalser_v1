...
await message.client.sendMessage(message.jid, fs.readFileSync('./uploads/richu(1).mp3'), MessageType.audio, { mimetype: Mimetype.mp4Audio, quoted : message.data, ptt: true})
        }
const array = ['kalam']
array.map( async (a) => {
